...
# model = model.MatchBoxNetreg(B=3, R=2, C=64)
model = model.LSTMRegression()

#LOAD THE MODEL FROM CKPT

path = '/data/saten/diana/SpeakingRateEstimation/SREregression/Models/rLSTM128/checkpoints/best-epoch=92-val_loss=2.99-val_pcc=0.86.ckpt'
